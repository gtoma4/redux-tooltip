    ...
    value: function render() {
      ...
      if (!props.onMouseEnter) {
        props.onMouseEnter = function (e) {
          ...
          var action = ['show', 'both'].indexOf(_this2.props.delayOn) !== -1 ? _this2.createWithDelay(_actions.show, { origin: originNode }) : (0, _actions.show)(_extends({}, _this2.props, { origin: originNode }));
