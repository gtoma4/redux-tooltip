    ...
    value: function render() {
      ...
      if (!props.onMouseEnter) {
        props.onMouseEnter = function (e) {
          ...
          var testNode = _this2.refs.wrapper;

          var action = ['show', 'both'].indexOf(_this2.props.delayOn) !== -1 ? _this2.createWithDelay(_actions.show, { origin: testNode }) : (0, _actions.show)(_extends({}, _this2.props, { origin: testNode }));
