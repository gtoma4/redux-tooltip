...
var Tooltip = function (_Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (origin && (Object.keys(this.state).length && !this.originSamePosition(origin, this.state) || (0, _utils.originOrEl)(this.props) != origin || this.props.place !== place || this.props.content !== content || this.props.children !== children)) {
    ...
    value: function updatePosition(props) {
      ...
      _reactDom2.default.render(_react2.default.createElement(
        ...
        setTimeout(function () {
          console.log('this.state after update', _this2.state);
        }, 0);
      });
    }
  }, {
    key: 'originSamePosition',
    value: function originSamePosition(origin1, statePosition) {
      ...
      return origin1.offsetLeft === statePosition.offset.left && origin1.offsetTop === statePosition.offset.top && origin1.offsetHeight === statePosition.offset.height && origin1.offsetWidth === statePosition.offset.width;
    }
  }, {
    key: 'children',
